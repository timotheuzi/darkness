...
from game.models import Player, NPC, Room, Item, InventoryItem, ChatMessage, ProceduralWeaponSpawn, Party, PartyMembership, GameWorld
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        if not kwargs.get('confirm'):
            ...
            self.stdout.write("Human players will be preserved but their inventory will be cleared.")
        ...
        with transaction.atomic():
            ...
            items_to_delete = Item.objects.exclude(
                inventoryitem__player__isnull=False
            )
            ...
            self.stdout.write(self.style.SUCCESS("World cleaned successfully. Run 'make init' to regenerate."))